...
public class ExamRestController {
    ...
    @ResponseBody
    public Exam createNewExam(@RequestBody RestExamDto examDTO) throws IncorrectSumOfTasksException, ParseException {
        return restExamService.addNewExam(examDTO);
    }

    @RequestMapping(path = "/api/exam/{id}", method = RequestMethod.PUT)
    @ResponseBody
    public RestExamDto changeExam(@PathVariable("id") Long examId, @RequestBody RestExamDto examDTO) throws ParseException {
        try {
